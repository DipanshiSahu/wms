...
class Uploadclientmappingfoliokarvy extends Component {
  ...
  addnewclient(e) {
    ...
    axios.post('http://localhost:3001/api/addfoliokarvy', { name: name, pan: pan, data: newdataarray,add1:add1,add2:add2,add3:add3 })
      .then(res => {
                      ...
                      <tbody id="qw">
                        {this.state.data1.map((item, index) => (
                          <tr>
                            ...
                            <td><a href="#" className="btn btn-sm btn-primary" onClick={() => this.addnewclient(item.INVNAME + "#" + item.PANGNO + "#" + index + "#" + item.ADD1 + "#" + item.ADD2 + "#" + item.ADD3)}>NEW CLIENT</a></td>
                          </tr>
                        ))}
